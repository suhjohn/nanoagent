...
declare const LSP_OPERATIONS: readonly [
  'goToDefinition',
  'findReferences',
  'hover',
  'documentSymbol',
...
export declare function createNodeLspClient(
  params: NodeLspClientParams
): LspClient
export declare function diagnosticsAfterEdit(
  client: LspClient,
  file: string
): Promise<unknown[]>
export {}
