import type { AgentRunState, JsonLike, RunAgentOptions } from '@nanoagent/kernel';
...
export type JsonlEntry = JsonlMessageEntry | JsonlCustomEntry | JsonlCompactionEntry | JsonlBranchEntry;
...
export declare function createFileJsonlSessionRepo<CONTEXT extends JsonLike>(params: FileJsonlSessionRepoParams): JsonlSessionRepo<CONTEXT>;
export declare function withJsonlSession<CONTEXT extends JsonLike>(params: JsonlSessionParams<CONTEXT>): AgentPlugin<CONTEXT>;
export declare function projectEntries(entries: readonly JsonlEntry[]): readonly Message[];
export {};
