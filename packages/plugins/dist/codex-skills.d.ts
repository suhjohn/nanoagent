...
export type CodexSkillRoot = string | {
    path: string;
...
export declare function withCodexSkills<CONTEXT extends JsonLike>(params?: CodexSkillsParams<CONTEXT>): AgentPlugin<CONTEXT>;
