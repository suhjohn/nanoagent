...
type Snapshotter<CONTEXT extends JsonLike, SNAPSHOT> = {
    ...
    restore?: (args: ToolCallSite<CONTEXT> & {
        snapshot: SNAPSHOT;
        error: unknown;
    }) => unknown | Promise<unknown>;
    diff?: (args: ToolCallSite<CONTEXT> & {
        snapshot: SNAPSHOT;
        output: unknown;
    }) => unknown | Promise<unknown>;
};
export declare function withSnapshots<CONTEXT extends JsonLike, SNAPSHOT>(snapshotter: Snapshotter<CONTEXT, SNAPSHOT>): AgentPlugin<CONTEXT>;
export {};
