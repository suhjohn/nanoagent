export function withRevertTools(params) {
    return withTools({
        revert_session: {
            description: 'Restore snapshot and remove message/part range after target session message. Use only when user requests revert.',
        ...
        unrevert_session: {
            description: 'Restore pre-revert snapshot and clear pending revert marker.',
